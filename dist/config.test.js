...
describe("resolveConfig", () => {
    it("requires queueUrl", () => {
        expect(() => resolveConfig({ queueUrl: "", region: "us-east-1" })).toThrow("SQS_MONITOR_QUEUE_URL is required");
    });
    it("requires region", () => {
        expect(() => resolveConfig({ queueUrl: "https://sqs.us-east-1.amazonaws.com/123/test", region: "" })).toThrow("AWS_REGION is required");
    });
    it("applies defaults", () => {
